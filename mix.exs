defmodule Membrane.Live.Mixfile do
  ...
  defp deps do
    [
      ...
      {:membrane_rtc_engine,
       github: "jellyfish-dev/membrane_rtc_engine", branch: "live-dev-update-core"},
      ...
      {:membrane_mp4_plugin, "~> 0.18.0", override: true},
      {:membrane_aac_plugin, "~> 0.13.0"},
      {:membrane_aac_fdk_plugin, "~> 0.14.0"},
      {:membrane_opus_plugin, "~> 0.16.0"},
      {:membrane_h264_ffmpeg_plugin, "~> 0.25.2", override: true},
