defmodule Membrane.Live.Mixfile do
  ...
  defp deps do
    [
      ...
      # Membrane
      {:membrane_rtc_engine, github: "jellyfish-dev/membrane_rtc_engine", branch: "live-compositor", override: true},
      ...
      {:membrane_audio_mix_plugin, git: "https://github.com/membraneframework/membrane_audio_mix_plugin.git", branch: "start-mixing-event"},
      {:membrane_raw_audio_format, "~> 0.10.0"},
      {:membrane_h264_ffmpeg_plugin, "~> 0.26.2"},
      {:membrane_audio_filler_plugin, "~> 0.1.0"},
      {:membrane_video_compositor_plugin, git: "https://github.com/membraneframework/membrane_video_compositor_plugin", branch: "add_schedule_eos_option"},
    ]
  end
