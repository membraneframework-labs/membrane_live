...
export const useWebinarProductsQuery = (productId: string) => useQuery({
...
export const useAllProductsQuery = (enabled: boolean) => useQuery({
...
export const useWebinarProducts = (webinarId: string): UseProducts => {
  ...
  const addProductMutation = useMutation({
    ...
    mutationFn: async (id: string) => await axiosWithInterceptor.post(`/resources/webinars/${webinarId}/products`, {productId: id}),
    onSuccess: async () => await refetch()
  })

  const removeProductMutation = useMutation({
    mutationKey: ["REMOVE-PRODUCT"],
    mutationFn: async (id: string) => await axiosWithInterceptor.delete(`/resources/webinars/${webinarId}/products/${id}`),
    onSuccess: async () => await refetch()
  })
  return {
    products,
