defmodule MembraneLive.Application do
  ...
  defp create_integrated_turn_cert_file() do
    cert_path = Application.fetch_env!(:membrane_live, :integrated_turn_cert)
    pkey_path = Application.fetch_env!(:membrane_live, :integrated_turn_pkey)
    ...
    if cert_path != nil and pkey_path != nil do
      ...
      Application.put_env(:membrane_live, :integrated_turn_cert_pkey, @cert_file_path)
    else
  ...
  defp config_common_dtls_key_cert() do
    ...
    :ok = ExDTLS.stop(pid)
    Application.put_env(:membrane_live, :dtls_pkey, pkey)
    Application.put_env(:membrane_live, :dtls_cert, cert)
  end
end
