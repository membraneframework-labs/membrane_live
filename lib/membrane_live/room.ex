defmodule MembraneLive.Room do
  ...
  def init(event_id) do
    ...
    client = Jellyfish.Client.new(server_address: "localhost:5002", server_api_token: "development")
    {:ok, notifier} = Jellyfish.WSNotifier.start(server_address: "localhost:5002", server_api_token: "development")
  ...
  def handle_call(:playable_playlist, _from, state) do
    {:reply, state.playlist_ready?, state}
  end
  ...
  def handle_info(
    ...
    handle_playlist_playable(state)
